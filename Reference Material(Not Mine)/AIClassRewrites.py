'''
Sadly, vanilla easyAI only provides most of the functionality I need.
The negamax algorithm they provide does not work with my agent idea, so I need
to redefine the basic classes and functionality provided in the modules.
I'm separating these from my original structures because I want to give credit
where credit is due.
'''
